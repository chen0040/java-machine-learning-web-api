...
import com.github.chen0040.ml.spark.utils.parsers.ARFFReader;
import com.github.chen0040.ml.tests.spark.utils.FileUtils;
import com.github.chen0040.ml.spark.utils.UrlData;
import com.github.chen0040.ml.spark.utils.parsers.ARFF;
...
public class ARFFUtils {
    ...
    public static JavaRDD<UrlData> loadSample(JavaSparkContext context) {
        ...
        return context.parallelize(dataSet);
    }
