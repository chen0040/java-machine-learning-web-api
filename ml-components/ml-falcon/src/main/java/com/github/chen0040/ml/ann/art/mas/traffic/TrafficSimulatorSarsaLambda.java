 ...
 */
public class TrafficSimulatorSarsaLambda extends TrafficSimulator {

    public TrafficSimulatorSarsaLambda(TrafficSimulatorConfig config, FalconConfig falconConfig){
    ...
    protected TrafficAgent createAgent(int agentId, Falcon brain){
        ...
        TDFalconTrafficAgent newAgent = new TDFalconTrafficAgent((TDLambdaFalcon)brain, agentId, TDMethod.Sarsa, numSonarInput, numAVSonarInput, numRangeInput);
    ...
    public static void main(String[] args){
        ...
        TrafficSimulatorSarsaLambda simulator = new TrafficSimulatorSarsaLambda(config, falconConfig);
        simulator.runSims();
    }
}
