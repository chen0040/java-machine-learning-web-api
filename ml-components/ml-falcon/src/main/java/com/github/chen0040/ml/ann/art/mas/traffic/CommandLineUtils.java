...
public class CommandLineUtils {
    public static TrafficSimulator procCommandLines(String[] args, TrafficSimulatorConfig simConfig, FalconConfig aiConfig){
        ...
        if(!simConfig.applyTDFALCON) {
            return new TrafficSimulatorAS(simConfig, aiConfig);
        }


        if(falconMode.equalsIgnoreCase("sarsa")) {
            return new TrafficSimulatorSarsa(simConfig, aiConfig);
        } else if(falconMode.equalsIgnoreCase("qlearn")) {
            return new TrafficSimulatorSarsa(simConfig, aiConfig);
        } else if(falconMode.equalsIgnoreCase("sarsalambda")) {
            return new TrafficSimulatorSarsaLambda(simConfig, aiConfig);
        } else if(falconMode.equalsIgnoreCase("r")) {
            return new TrafficSimulatorR(simConfig, aiConfig);
        } else {
            return new TrafficSimulatorQLambda(simConfig, aiConfig);
        }
    }
}
