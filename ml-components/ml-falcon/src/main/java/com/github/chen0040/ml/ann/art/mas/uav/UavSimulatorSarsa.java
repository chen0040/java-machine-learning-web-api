 ...
 */
public class UavSimulatorSarsa extends UavSimulator {

    public UavSimulatorSarsa(UavSimulatorConfig config, FalconConfig falconConfig){
    ...
    public static void main(String[] args){
        ...
        UavSimulatorSarsa simulator = new UavSimulatorSarsa(config, falconConfig);
        simulator.runSims();
    }
}
